...
public class ViewPackage extends JFrame implements ActionListener {
    ...
    ViewPackage(String username){
        ...
        JLabel lblelphone=new JLabel();
        lblelphone.setBounds(220,250,150,25);
        add(lblelphone);
        ...
        JLabel lblelprice=new JLabel();
        lblelprice.setBounds(220,290,150,25);
        add(lblelprice);
        ...
        try{
            ...
            while(rs.next()){
                ...
                lblelprice.setText(rs.getString("price"));
