...
public class BookHostel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookHostel frame = new BookHostel("");
	...
	public BookHostel(String username) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	    			...
	    			String s1 = c1.getSelectedItem(); 
                                ...
                                String q1 = "insert into bookhotel values('"+l1.getText()+"','"+c1.getSelectedItem()+"', '"+t1.getText()+"', '"+t2.getText()+"','"+c2.getSelectedItem()+"','"+l2.getText()+"', '"+l3.getText()+"','"+l4.getText()+"' ,'"+l5.getText()+"')";
