...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    JLabel labelusername,labelname ,username;
    JComboBox comboid;
    ...
    AddCustomer(String user){
        ...
        image.setBounds(500,60,450,420);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            ...
            try{
                Conn c= new Conn();
                String query="INSERT INTO customer values('"+username+"','"+id+"','"+number+"','"+gender+"','"+country+"','"+address+"','"+phone+"','"+email+"','"+name+"')";
